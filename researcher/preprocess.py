...
if __name__ == "__main__":
    ...
    table.add_row(
        "Average Tokens",
        f"{token_stats['documents']['avg']:,} tokens",
        ""
    )
    table.add_row(
        "Median Tokens",
        f"{token_stats['documents']['median']:,} tokens",
        ""
    )
    table.add_row(
        "Total Tokens",
        f"{token_stats['documents']['total']:,} tokens",
        ""
    )
    table.add_row(
        "Document Count",
        f"{len(processed_files):,} documents",
        ""
    )
    table.add_row(
        "Chunk Count",
        f"{token_stats['chunks']['count']:,} chunks",
        ""
    )
