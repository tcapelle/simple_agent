...
def get_special_tokens_set() -> set:
    """
    Returns a set of special tokens to be removed from text.

    Returns:
        A set of special tokens.
    """
    return {"<special_token>", "<another_special_token>"}  # Example special tokens
